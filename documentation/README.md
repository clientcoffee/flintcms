...
- **components.md** – core vs. user components, asset hooks, namespaces.
- **hooks.md** – hook names and template helper shortcuts.
- **themes.md** – layout cascade, helper hooks, global data, asset tiers.
- **structure.md** – directory map, update-safe paths, generated dist artifacts.
- **backup.md** – backup, export, restore, reinstall guidance.
